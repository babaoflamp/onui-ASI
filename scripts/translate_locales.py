...
SOURCE_FILE = Path("data/locales/ko.json")
...
def translate_with_gemini(source_data, target_lang_name):
    ...
    prompt = f"""
    You are an expert app localizer. Translate the values of the following JSON from Korean to {target_lang_name}.
...
def main():
    ...
    print("📖 원본 한국어 파일(ko.json)을 읽어옵니다...")
